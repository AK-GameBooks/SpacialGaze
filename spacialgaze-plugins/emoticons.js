...
const fs = require('fs');
let emoticons = {'feelsbd': 'https://cdn.betterttv.net/emote/55b6e2e03293ee267743902b/2x', 'xaa': 'https://m.imgur.com/V728AvL.png',
		 'feelscrazy': 'http://i.imgur.com/NiJsT5W.png',
		 'feelsterrible': 'http://i.imgur.com/oA780DR.png',
		 'feelsshake': 'http://i.imgur.com/OUdKETM.gif',
		 'feelsgd': 'https://m.imgur.com/87zXwfR.png',
		 'obama': 'http://i.imgur.com/rBA9M7A.png',
		 'facepalm': 'https://m.imgur.com/lv3GmpM.png',
		 'kappa': 'https://m.imgur.com/ZxRU4z3.png',
		 'feelsded': 'http://i.imgur.com/Pe82uO4.png',
		 'feelspride': 'http://i.imgur.com/IVzXwJL.gif',
		 'feelsno': 'http://i.imgur.com/oSeraFB.gif',
		 'feelscool': 'https://m.imgur.com/YVI1AzR.png',
		 'feelsyeah': 'http://i.imgur.com/0jjBGHL.gif',
		 'feelsbetrayed': 'https://m.imgur.com/a7K7wfv.png',
